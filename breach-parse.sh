...
if [ $# -lt 2 ]; then
    ...
    echo "You only need to specify [breach data location] if its not in the expected location (current directory)"
    echo " "
    ...
    breachDataLocation="./BreachCompilation/data"
...
##modified by https://github.com/l1ack0der
